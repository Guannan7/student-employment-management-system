<template>
  <div>
    ...
    <el-form :model="rulesForm" :rules="rules" ref="rulesForm" class="login-form">
      ...
      <el-form-item label="">
        <a style="margin-right:10px" href="javascript:void(0)" @click="register('yonghu')">学生注册</a>
        <a style="margin-right:10px" href="javascript:void(0)" @click="register('qiyexinxi')">企业注册</a>
      </el-form-item>
